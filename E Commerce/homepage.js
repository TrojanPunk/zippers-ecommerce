...
function displayProducts(products) {
    ...
    filteredProducts.forEach(function (product) {
        if (isValidProduct(product)) {
            ...
            card.innerHTML = "\n                <div class=\"card\" data-product-id=\"".concat(product.id, "\">\n                    <div class=\"image-container\">\n                        <img src=\"").concat(product.image, "\" class=\"card-img-top\" alt=\"").concat(product.title, "\">\n                    </div>\n                    <div class=\"card-body\">\n                        <h5 class=\"card-title\">").concat(product.title, "</h5>\n                        <p class=\"card-text\">Rating: ").concat(product.rating.rate, " (").concat(product.rating.count, " reviews)</p>\n                        <p class=\"card-text\" id=\"price\">Price: $").concat(product.price, "</p>\n                        <button class=\"btn btn-primary add-to-cart\" data-product-id=\"").concat(product.id, "\">Add to Cart</button>\n                    </div>\n                </div>\n            ");
